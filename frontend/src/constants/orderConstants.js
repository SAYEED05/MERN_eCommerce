...
export const ORDER_CASH_RECEIVED_REQUEST = "ORDER_CASH_RECEIVED_REQUEST";
export const ORDER_CASH_RECEIVED_SUCCESS = "ORDER_CASH_RECEIVED_SUCCESS";
export const ORDER_CASH_RECEIVED_FAIL = "ORDER_CASH_RECEIVED_FAIL";
export const ORDER_CASH_RECEIVED_RESET = "ORDER_CASH_RECEIVED_RESET";
